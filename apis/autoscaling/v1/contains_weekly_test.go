...
func TestScheduleSpecContainsWeekly(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "1day case[1]",
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Monday", EndDayOfWeek: "Monday", StartTime: "10:00", EndTime: "19:00"},
		...
		// 1 day case with minutes
		{
			...
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Monday", EndDayOfWeek: "Monday", StartTime: "10:00", EndTime: "10:30"},
		...
		// EndTime is over 24 o'clock.
		{
			...
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Monday", EndDayOfWeek: "Monday", StartTime: "15:00", EndTime: "01:00"},
		...
		// EndTime is over 24 o'clock with minutes case.
		{
			...
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Monday", EndDayOfWeek: "Monday", StartTime: "15:00", EndTime: "01:30"},
		...
		// EndTime is over 24 o'clock, 2 days.
		{
			...
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Monday", EndDayOfWeek: "Tuesday", StartTime: "15:00", EndTime: "01:30"},
		...
		// the middle day in 3 days
		{
			...
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Monday", EndDayOfWeek: "Wednesday", StartTime: "15:00", EndTime: "01:30"},
		...
		// StartDayOfWeek is bigger than EndDayOfWeek
		{
			...
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Tuesday", EndDayOfWeek: "Sunday", StartTime: "15:00", EndTime: "01:30"},
		...
		{
			name:     "everyday[1]",
			spec:     ScheduleSpec{ScheduleType: Weekly, StartDayOfWeek: "Sunday", EndDayOfWeek: "Saturday", StartTime: "15:00", EndTime: "01:30"},
			now:      time.Date(2018, 9, 3, 1, 20, 0, 0, time.UTC),
			expected: true,
		},
		{
